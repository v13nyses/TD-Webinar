...
#  url(r'^event/(?P<event_id>\d+)/register/$', 'registration.views.register', name = "register"),
  ...
  url(r'^event/(?P<event_id>\d+)/register/(?P<message>.*)$', 'registration.views.register', name = "register"),
  url(r'^event/(?P<event_id>\d+)/register$', 'registration.views.register', name = "register"),
  ...
  url(r'^event/(?P<event_id>\d+)/engagement/(?P<start_offset>\d+)/(?P<duration>\d+)$', 'reporting.views.update_engagement', name = 'engagement'),
